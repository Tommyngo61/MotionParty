...
- Every request carries a fresh signature over the method, path, and a
  ...
  node. See [console ADR 0004](../console/ADR/0004-signed-credentials-with-proof-of-possession.md).
...
- A **hardware fingerprint change never re-binds silently.** It quarantines the
  ...
  See [console ADR 0005](../console/ADR/0005-fingerprint-change-never-auto-rebinds.md).
