...
//
// See ADR 0002 in meter-node-console for the reasoning behind MessagePack +
// zstd rather than protobuf:
// https://github.com/MeterHome/Meter-Node/console/blob/main/ADR/0002-messagepack-zstd-over-protobuf.md
