...
The MeterNode wire schema. Imported by both [`meternode-console`](../meternode-console)
(the controller) and [`meternode-agent`](../meternode-agent). Neither side
hand-rolls a struct that crosses the network.
